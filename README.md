...
- **Fame.** Once the level track caps out, the experience your kitchen earns becomes fame instead, and fame buys stars. The first ten each hand over something real — a recipe, a showpiece, a face, a menu slot or a staff position past the usual ceiling — along with the title the diner is known by, from *Word of Mouth* through *Diner of the Year* to *The Town's Table*. After that stars keep counting, so the number is a score rather than a second wall. The fame bar only appears at the cap; nothing about the first hour changes.
...
- **Regulars.** Eight named guests come back on their own cadence from your first morning, and five more arrive with the food they came for at the far end of the climb, each hoping for a particular dish drawn from your menu. Serve it to one of them while they are still in a good mood and they tip, hand over experience and return sooner; walk them out and it costs you twice over and they stay away. Manage lists who is due and what they are hoping for.
...
the cap into fame and unlock what the star promised, every one of the ten stars
has to put a recipe or a shop piece in front of the player while the two capacity
...
- **One world, one kind of solid.** The furniture, the street outside and the people are all stacked iso boxes with a lit top and two shaded sides, and detail — a shopfront, a face, a row of a chef's buttons — is painted through the plane of the box it belongs to rather than flat across the front of it. Figures are assembled in their own frame rather than mirrored, so somebody who turns away really does show you the back of their head.
